#!/usr/bin/env python3
"""
Metal Price Fetcher - Process 2
Fetches real-time metal prices (Lithium ETF, aluminum, nickel, zinc, platinum) from Yahoo Finance and stores in database
"""
...
def fetch_all_metal_prices():
    """Fetch prices for all metals including lithium"""
    metals = [
        {'symbol': 'LIT', 'name': 'Lithium ETF'},  # Global X Lithium & Battery Tech ETF
...
def main():
    ...
    logging.info("🚀 Starting Metal Price Fetcher (Process 2)")
    ...
    try:
        ...
        logging.error(f"❌ Error in metal price fetcher: {e}")
        raise
